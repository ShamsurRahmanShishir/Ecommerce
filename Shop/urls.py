...
urlpatterns = [
    ...
    path('combo/', views.Combo.as_view(),name="combo"),
    ...
    path('Laptop/<slug:data>', views.Laptop, name='Laptopitem'),
    path('MobilePhone/<slug:data>', views.MobilePhone, name='MobilePhoneitem'),
